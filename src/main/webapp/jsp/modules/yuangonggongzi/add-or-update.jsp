...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑员工工资</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑员工工资</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>月份</label>
					<input name="yuefen" id="yuefen" name="yuefen" class="form-control" placeholder="请输入月份">
				</div>
				<div class="form-item">
					<label>工号</label>
					<input name="gonghao" id="gonghao" name="gonghao" class="form-control" placeholder="请输入工号">
				</div>
				<div class="form-item">
					<label>姓名</label>
				...
				<div class="form-item">
					<label>部门</label>
					<input name="bumen" id="bumen" name="bumen" class="form-control" placeholder="请输入部门">
				</div>
				<div class="form-item">
					<label>职位</label>
					<input name="zhiwei" id="zhiwei" name="zhiwei" class="form-control" placeholder="请输入职位">
				</div>
				...
				<div class="form-item">
					<label>基本工资</label>
					<input id="jibengongzi" name="jibengongzi" class="form-control" onchange="calculation()" placeholder="请输入基本工资">
				</div>
				<div class="form-item">
					<label>加班工资</label>
					<input id="jiabangongzi" name="jiabangongzi" class="form-control" onchange="calculation()" placeholder="请输入加班工资">
				</div>
				<div class="form-item">
					<label>绩效奖金</label>
					<input id="jixiaojiangjin" name="jixiaojiangjin" class="form-control" onchange="calculation()" placeholder="请输入绩效奖金">
				</div>
				<div class="form-item">
					<label>其他补助</label>
					<input id="qitabuzhu" name="qitabuzhu" class="form-control" onchange="calculation()" placeholder="请输入其他补助">
				</div>
				<div class="form-item">
					<label>扣款金额</label>
					<input id="koukuanjine" name="koukuanjine" class="form-control" onchange="calculation()" placeholder="请输入扣款金额">
				</div>	
				<div class="form-item">
					<label>扣款原因</label>
					<textarea  name="koukuanyuanyin" class="form-control textarea" id="koukuanyuanyin" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>实发工资</label>
					<input name="shifagongzi" id="shifagongzi" name="shifagongzi" class="form-control" placeholder="请输入实发工资">
				</div>
				<div class="form-item">
					<label>福利</label>
					<textarea  name="fuli" class="form-control textarea" id="fuli" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>发布日期</label>
	...
	<script>
		...
		function calculation(){
			...
			if($("#koukuanjine").val() != null && $("#koukuanjine").val() != ""){
				y = y - parseFloat($("#koukuanjine").val());
			}
			$("#shifagongzi").val(y);
		...
		function dataBind(){
			...
			$("#koukuanjine").val(ruleForm.koukuanjine);	
			$("#koukuanyuanyin").val(ruleForm.koukuanyuanyin);
			$("#shifagongzi").val(ruleForm.shifagongzi);	
			$("#fuli").val(ruleForm.fuli);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.koukuanjine != null && res.data.koukuanjine != ''){

						$("#koukuanjine").val(res.data.koukuanjine);
						$("#koukuanjine").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.koukuanyuanyin != null && res.data.koukuanyuanyin != ''){

						$("#koukuanyuanyin").val(res.data.koukuanyuanyin);
					}
					...
					if(res.data != null && res.data != '' && res.data.fuli != null && res.data.fuli != ''){

						$("#fuli").val(res.data.fuli);
					}
