...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">员工工资管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>员工工资列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>月份</label>
					<input type="text" id="yuefenSearch" class="form-control form-control-sm" placeholder="请输入月份" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>工号</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('qitabuzhu')">其他补助<i id="qitabuzhuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('koukuanjine')">扣款金额<i id="koukuanjineIcon" class="fa fa-sort"></i></th>
						<th>扣款原因</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var qitabuzhuCell  = document.createElement('td');

						 qitabuzhuCell.innerHTML = item.qitabuzhu;

			row.appendChild(qitabuzhuCell);
			var koukuanjineCell  = document.createElement('td');

						 koukuanjineCell.innerHTML = item.koukuanjine;

			row.appendChild(koukuanjineCell);
			var koukuanyuanyinCell  = document.createElement('td');

						  if(item.koukuanyuanyin != null && item.koukuanyuanyin != "" && item.koukuanyuanyin.length >= 11){
			  	koukuanyuanyinCell.innerHTML = item.koukuanyuanyin.substring(0, 10) + "..."; 
			  }else{
			  	koukuanyuanyinCell.innerHTML = item.koukuanyuanyin;
			  }


			row.appendChild(koukuanyuanyinCell);
			var shifagongziCell  = document.createElement('td');

						 shifagongziCell.innerHTML = item.shifagongzi;

			row.appendChild(shifagongziCell);
			var fuliCell  = document.createElement('td');

						  if(item.fuli != null && item.fuli != "" && item.fuli.length >= 11){
			  	fuliCell.innerHTML = item.fuli.substring(0, 10) + "..."; 
			  }else{
			  	fuliCell.innerHTML = item.fuli;
			  }


			row.appendChild(fuliCell);
		...
		function sh(){
			...
			httpJson("yuangonggongzi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
