...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑参加培训</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>参加培训管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑参加培训</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>培训标题</label>
					<input name="peixunbiaoti" id="peixunbiaoti" name="peixunbiaoti" class="form-control" placeholder="请输入培训标题">
				</div>
				<div class="form-item">
					<label>培训日期</label>
					<input name="peixunriqi" id="peixunriqi" name="peixunriqi" class="form-control" placeholder="请输入培训日期">
				</div>
				...
				<div class="form-item">
					<label>培训天数</label>
					<input name="peixuntianshu" id="peixuntianshu" name="peixuntianshu" class="form-control" placeholder="请输入培训天数">
				</div>
				<div class="form-item">
					<label>培训目的</label>
					<input name="peixunmude" id="peixunmude" name="peixunmude" class="form-control" placeholder="请输入培训目的">
				</div>
				<div class="form-item">
					<label>培训备注</label>
					<input name="peixunbeizhu" id="peixunbeizhu" name="peixunbeizhu" class="form-control" placeholder="请输入培训备注">
				</div>
				<div class="form-item">
					<label>参加时间</label>
					<input id="canjiashijian-input" class="date" name="canjiashijian" size="15" type="text" readonly placeholder="请选择参加时间">
				</div>
				<div class="form-item">
					<label>工号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "canjiapeixun/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("canjiapeixun/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("canjiapeixun/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("canjiapeixun/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#canjiashijian-input").val(getCurDate());
		...
		function dataBind(){
			...
			$("#peixunbiaoti").val(ruleForm.peixunbiaoti);	
			$("#peixunriqi").val(ruleForm.peixunriqi);	
            if(ruleForm.tupian){
                vm.tupianImgList = ruleForm.tupian.split(',')
            }
			$("#tupian-input").val(ruleForm.tupian);
			$("#peixuntianshu").val(ruleForm.peixuntianshu);	
			$("#peixunmude").val(ruleForm.peixunmude);	
			$("#peixunbeizhu").val(ruleForm.peixunbeizhu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.peixunbiaoti != null && res.data.peixunbiaoti != ''){

						$("#peixunbiaoti").val(res.data.peixunbiaoti);
						$("#peixunbiaoti").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.peixunriqi != null && res.data.peixunriqi != ''){

						$("#peixunriqi").val(res.data.peixunriqi);
						$("#peixunriqi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.tupian != null && res.data.tupian != ''){

                        vm.tupianImgList = res.data.tupian.split(',')
					}
					if(res.data != null && res.data != '' && res.data.peixuntianshu != null && res.data.peixuntianshu != ''){

						$("#peixuntianshu").val(res.data.peixuntianshu);
						$("#peixuntianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.peixunmude != null && res.data.peixunmude != ''){

						$("#peixunmude").val(res.data.peixunmude);
						$("#peixunmude").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.peixunbeizhu != null && res.data.peixunbeizhu != ''){

						$("#peixunbeizhu").val(res.data.peixunbeizhu);
						$("#peixunbeizhu").attr('readonly','readonly');
					}
