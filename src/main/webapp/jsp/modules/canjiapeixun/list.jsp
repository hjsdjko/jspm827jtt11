...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">参加培训管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>参加培训列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>培训标题</label>
					<input type="text" id="peixunbiaotiSearch" class="form-control form-control-sm" placeholder="请输入培训标题" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>培训天数</label>
					<input type="text" id="peixuntianshuSearch" class="form-control form-control-sm" placeholder="请输入培训天数" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>审核状态</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('peixunbiaoti')">培训标题<i id="peixunbiaotiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('peixunriqi')">培训日期<i id="peixunriqiIcon" class="fa fa-sort"></i></th>
						<th>图片</th>
						<th onclick="sort('peixuntianshu')">培训天数<i id="peixuntianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('peixunmude')">培训目的<i id="peixunmudeIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('peixunbeizhu')">培训备注<i id="peixunbeizhuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#peixunbiaotiSearch').val() != null && $('#peixunbiaotiSearch').val() != ''){
				searchForm.peixunbiaoti ="%" +  $('#peixunbiaotiSearch').val() + "%";
			}
			
			if($('#peixuntianshuSearch').val() != null && $('#peixuntianshuSearch').val() != ''){
				searchForm.peixuntianshu ="%" +  $('#peixuntianshuSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("canjiapeixun/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				peixunbiaoti : searchForm.peixunbiaoti,	
				peixuntianshu : searchForm.peixuntianshu,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var peixunbiaotiCell  = document.createElement('td');

						 peixunbiaotiCell.innerHTML = item.peixunbiaoti;

			row.appendChild(peixunbiaotiCell);
			...
			var peixuntianshuCell  = document.createElement('td');

						 peixuntianshuCell.innerHTML = item.peixuntianshu;

			row.appendChild(peixuntianshuCell);
			var peixunmudeCell  = document.createElement('td');

						 peixunmudeCell.innerHTML = item.peixunmude;

			row.appendChild(peixunmudeCell);
			var peixunbeizhuCell  = document.createElement('td');

						 peixunbeizhuCell.innerHTML = item.peixunbeizhu;

			row.appendChild(peixunbeizhuCell);
		...
		function sh(){
			...
			httpJson("canjiapeixun/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("canjiapeixun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"canjiapeixun");
