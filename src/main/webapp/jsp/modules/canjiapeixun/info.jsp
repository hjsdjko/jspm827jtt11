...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看参加培训</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看参加培训</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="peixunmude" name="peixunmude" class="form-control" v-model="ruleForm.peixunmude" readonly>
				</div>
				<div class="form-item">
					<label>培训备注</label>
