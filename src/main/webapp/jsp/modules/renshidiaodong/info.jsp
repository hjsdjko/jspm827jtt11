...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看人事调动</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看人事调动</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="xianbumen" name="xianbumen" class="form-control" v-model="ruleForm.xianbumen" readonly>
				</div>
				<div class="form-item">
					<label>调动职位</label>

					<input id="xianzhiwei" name="xianzhiwei" class="form-control" v-model="ruleForm.xianzhiwei" readonly>
				</div>
				<div class="form-item">
					<label>调动日期</label>

					<input id="diaodongriqi" name="diaodongriqi" class="form-control" v-model="ruleForm.diaodongriqi" readonly>
				</div>
				<div class="form-item">
					<label>人事工号</label>
