...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">人事调动管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>人事调动列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>原部门</label>
					<input type="text" id="bumenSearch" class="form-control form-control-sm" placeholder="请输入原部门" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>审核状态</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('bumen')">原部门<i id="bumenIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('zhiwei')">原职位<i id="zhiweiIcon" class="fa fa-sort"></i></th>
						<th>照片</th>
						<th onclick="sort('xianbumen')">调动部门<i id="xianbumenIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('xianzhiwei')">调动职位<i id="xianzhiweiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('diaodongriqi')">调动日期<i id="diaodongriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xianbumenCell  = document.createElement('td');

						 xianbumenCell.innerHTML = item.xianbumen;

			row.appendChild(xianbumenCell);
			var xianzhiweiCell  = document.createElement('td');

						 xianzhiweiCell.innerHTML = item.xianzhiwei;

			row.appendChild(xianzhiweiCell);
			var diaodongriqiCell  = document.createElement('td');

						  diaodongriqiCell.innerHTML = item.diaodongriqi;


			row.appendChild(diaodongriqiCell);
		...
		function sh(){
			...
			httpJson("renshidiaodong/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("renshidiaodong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"renshidiaodong");
