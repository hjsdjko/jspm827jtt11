...
<body>
	<div id="main-container">
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>招聘职位</label>
					<input type="text" id="zhaopinzhiweiSearch" class="form-control form-control-sm" placeholder="请输入招聘职位" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>职位要求</label>
					<input type="text" id="zhiweiyaoqiuSearch" class="form-control form-control-sm" placeholder="请输入职位要求" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>审核状态</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>企业封面</th>
						<th>企业简介</th>
						<th onclick="sort('zhaopinzhiwei')">招聘职位<i id="zhaopinzhiweiIcon" class="fa fa-sort"></i></th>
						<th>职位要求</th>
						...
						<th onclick="sort('gonghao')">人事工号<i id="gonghaoIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('xingming')">人事姓名<i id="xingmingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#zhaopinzhiweiSearch').val() != null && $('#zhaopinzhiweiSearch').val() != ''){
				searchForm.zhaopinzhiwei ="%" +  $('#zhaopinzhiweiSearch').val() + "%";
			}
			
			if($('#zhiweiyaoqiuSearch').val() != null && $('#zhiweiyaoqiuSearch').val() != ''){
				searchForm.zhiweiyaoqiu ="%" +  $('#zhiweiyaoqiuSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("zhaopinxinxi/page","GET",{
				...
				zhaopinzhiwei : searchForm.zhaopinzhiwei,	
				zhiweiyaoqiu : searchForm.zhiweiyaoqiu,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var qiyefengmianCell  = document.createElement('td');

			            var qiyefengmianImg = document.createElement('img');
            qiyefengmianImg.setAttribute('src',item.qiyefengmian?(baseUrl+item.qiyefengmian.split(",")[0]):'');
			qiyefengmianImg.setAttribute('height',100);
			qiyefengmianImg.setAttribute('width',100);
			qiyefengmianCell.appendChild(qiyefengmianImg);


			row.appendChild(qiyefengmianCell);
			...
			var zhaopinzhiweiCell  = document.createElement('td');

						 zhaopinzhiweiCell.innerHTML = item.zhaopinzhiwei;

			row.appendChild(zhaopinzhiweiCell);
		...
		function sh(){
			...
			httpJson("zhaopinxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
