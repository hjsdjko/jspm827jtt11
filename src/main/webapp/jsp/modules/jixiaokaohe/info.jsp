...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看绩效考核</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看绩效考核</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="gongzuotaidu" name="gongzuotaidu" class="form-control" v-model="ruleForm.gongzuotaidu" readonly>
				</div>
				<div class="form-item">
					<label>员工考勤</label>

					<input id="yuangongkaoqin" name="yuangongkaoqin" class="form-control" v-model="ruleForm.yuangongkaoqin" readonly>
				</div>
				<div class="form-item">
					<label>业务技能</label>

					<input id="yewujineng" name="yewujineng" class="form-control" v-model="ruleForm.yewujineng" readonly>
				</div>
				<div class="form-item">
					<label>工作绩效</label>

					<input id="gongzuojixiao" name="gongzuojixiao" class="form-control" v-model="ruleForm.gongzuojixiao" readonly>
				</div>
				<div class="form-item">
					<label>总得分</label>
