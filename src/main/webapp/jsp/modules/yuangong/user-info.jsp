	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>工号</label>
					<input name="gonghao" readonly id="gonghao" name="gonghao" class="form-control" placeholder="请输入工号">
				</div>
				<div class="form-item">
					<label>姓名</label>
				...
				<div class="form-item">
					<label>部门</label>
					<select id="bumenSelect" name="bumen" disabled="disabled" class="form-control" onchange="bumenChange1('bumen')">
							<option value="">请选择部门</option>
					</select>	
				</div>	
				<div class="form-item">
					<label>职位</label>
					<select id="zhiweiSelect" name="zhiwei" disabled="disabled" class="form-control" onchange="zhiweiChange2('zhiwei')">
