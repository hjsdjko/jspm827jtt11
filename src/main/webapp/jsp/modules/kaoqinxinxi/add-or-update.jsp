...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑考勤信息</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>考勤信息管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑考勤信息</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>应出勤天数</label>
					<input id="yingchuqintianshu" name="yingchuqintianshu" class="form-control" onchange="calculation()" placeholder="请输入应出勤天数">
				</div>
				<div class="form-item">
					<label>请假天数</label>
					<input id="qingjiatianshu" name="qingjiatianshu" class="form-control" onchange="calculation()" placeholder="请输入请假天数">
				</div>	
				<div class="form-item">
					<label>迟到次数</label>
					<input name="chidaocishu" id="chidaocishu" name="chidaocishu" class="form-control" placeholder="请输入迟到次数">
				</div>
				<div class="form-item">
					<label>出差天数</label>
					<input id="chuchatianshu" name="chuchatianshu" class="form-control" onchange="calculation()" placeholder="请输入出差天数">
				</div>	
				<div class="form-item">
					<label>旷工天数</label>
					<input id="kuanggongtianshu" name="kuanggongtianshu" class="form-control" onchange="calculation()" placeholder="请输入旷工天数">
				</div>	
				<div class="form-item">
					<label>实到天数</label>
					<input name="shidaotianshu" id="shidaotianshu" name="shidaotianshu" class="form-control" placeholder="请输入实到天数">
				</div>
				<div class="form-item">
					<label>登记时间</label>
	...
	<script>
		...
		function calculation(){
			...
			var y = 0;
			var flag = 0;
			if($("#yingchuqintianshu").val() != null && $("#yingchuqintianshu").val() != ""){
				y = y + parseFloat($("#yingchuqintianshu").val());
			}
			if($("#qingjiatianshu").val() != null && $("#qingjiatianshu").val() != ""){
				y = y - parseFloat($("#qingjiatianshu").val());
			}
			if($("#chuchatianshu").val() != null && $("#chuchatianshu").val() != ""){
				y = y - parseFloat($("#chuchatianshu").val());
			}
			if($("#kuanggongtianshu").val() != null && $("#kuanggongtianshu").val() != ""){
				y = y - parseFloat($("#kuanggongtianshu").val());
			}
			$("#shidaotianshu").val(y);
		...
		function dataBind(){
			...
			$("#yingchuqintianshu").val(ruleForm.yingchuqintianshu);	
			$("#qingjiatianshu").val(ruleForm.qingjiatianshu);	
			$("#chidaocishu").val(ruleForm.chidaocishu);	
			$("#chuchatianshu").val(ruleForm.chuchatianshu);	
			$("#kuanggongtianshu").val(ruleForm.kuanggongtianshu);	
			$("#shidaotianshu").val(ruleForm.shidaotianshu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yingchuqintianshu != null && res.data.yingchuqintianshu != ''){

						$("#yingchuqintianshu").val(res.data.yingchuqintianshu);
						$("#yingchuqintianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.qingjiatianshu != null && res.data.qingjiatianshu != ''){

						$("#qingjiatianshu").val(res.data.qingjiatianshu);
						$("#qingjiatianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chidaocishu != null && res.data.chidaocishu != ''){

						$("#chidaocishu").val(res.data.chidaocishu);
						$("#chidaocishu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chuchatianshu != null && res.data.chuchatianshu != ''){

						$("#chuchatianshu").val(res.data.chuchatianshu);
						$("#chuchatianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.kuanggongtianshu != null && res.data.kuanggongtianshu != ''){

						$("#kuanggongtianshu").val(res.data.kuanggongtianshu);
						$("#kuanggongtianshu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.shidaotianshu != null && res.data.shidaotianshu != ''){

						$("#shidaotianshu").val(res.data.shidaotianshu);
						$("#shidaotianshu").attr('readonly','readonly');
					}
