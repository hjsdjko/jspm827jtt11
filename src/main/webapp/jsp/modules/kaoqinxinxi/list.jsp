...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">考勤信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>考勤信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('yingchuqintianshu')">应出勤天数<i id="yingchuqintianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('qingjiatianshu')">请假天数<i id="qingjiatianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('chidaocishu')">迟到次数<i id="chidaocishuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('chuchatianshu')">出差天数<i id="chuchatianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('kuanggongtianshu')">旷工天数<i id="kuanggongtianshuIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('shidaotianshu')">实到天数<i id="shidaotianshuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yingchuqintianshuCell  = document.createElement('td');

						 yingchuqintianshuCell.innerHTML = item.yingchuqintianshu;

			row.appendChild(yingchuqintianshuCell);
			...
			var chidaocishuCell  = document.createElement('td');

						 chidaocishuCell.innerHTML = item.chidaocishu;

			row.appendChild(chidaocishuCell);
			var chuchatianshuCell  = document.createElement('td');

						 chuchatianshuCell.innerHTML = item.chuchatianshu;

			row.appendChild(chuchatianshuCell);
			var kuanggongtianshuCell  = document.createElement('td');

						 kuanggongtianshuCell.innerHTML = item.kuanggongtianshu;

			row.appendChild(kuanggongtianshuCell);
			var shidaotianshuCell  = document.createElement('td');

						 shidaotianshuCell.innerHTML = item.shidaotianshu;

			row.appendChild(shidaotianshuCell);
		...
		function sh(){
			...
			httpJson("kaoqinxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
